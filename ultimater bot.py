...
def main():
    ...
    pg.screenshot('answer2.png', region=(
    60, 206, 130, 17))  # region=(x,y,width,height) also may vary depending on your screen resolution
...
window = sg.Window("hi", layout, location=(1000, 0), keep_on_top=True,
                   finalize=True)  # keep_on_top=True makes the window stay on top
while True:
